"""Incremental update orchestrator for OntoAgent."""
...
from ontoagent.pipeline.builder_utils import entity_to_dict, entity_to_text
from ontoagent.pipeline.change_detector import ChangeType

if TYPE_CHECKING:
    from ontoagent.pipeline.impact_propagator import ImpactReport
...
class IncrementalUpdater:
    ...
    def __init__(self, config: OntoAgentConfig, repo_path: Path | None = None) -> None:
        """初始化。
    ...
    def _get_change_detector(self):
        ...
        if self._change_detector is None:
            from ontoagent.pipeline.change_detector import GitChangeDetector
