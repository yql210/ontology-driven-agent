...
def _load_migration(version: str) -> MigrationBase:
    ...
    if version == "2.2.0":
        from ontoagent.store.migrations.v2_2_0_stable_entity_id import (
            StableEntityIdMigration,
        )

        return StableEntityIdMigration()
    if version == "2.3.0":
        from ontoagent.store.migrations.v2_3_0_multi_repo import (
            MultiRepoMigration,
        )
