...
class TestConfigBuildFields:
    ...
    def test_config_build_include_docs_from_env(self) -> None:
        # Arrange
        original = os.getenv("ONTOAGENT_BUILD_INCLUDE_DOCS")
        try:
            # Act
            os.environ["ONTOAGENT_BUILD_INCLUDE_DOCS"] = "false"
            ...
            if original is None:
                os.environ.pop("ONTOAGENT_BUILD_INCLUDE_DOCS", None)
            else:
                os.environ["ONTOAGENT_BUILD_INCLUDE_DOCS"] = original
