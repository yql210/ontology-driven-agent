...
def _reset_registry() -> None:
    ...
    from ontoagent.execution.functions.builtin import register_all as register_builtins
    from ontoagent.execution.functions.general import register_all as register_general
